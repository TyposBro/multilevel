...
sendInvoice — метод, который использует бот мерчанта для отправки счёта. В случае успешной отправки возвращается объект Message

PreCheckoutQuery — объект, который возвращает Bot API перед оплатой.

answerPreCheckoutQuery — когда пользователь подтвердил оплату и доставку, Bot API отправляет подтверждение с полем pre_checkout_query. Метод answerPreCheckoutQuery используется для ответа на запрос перед оплатой. В случае успеха метод возвращает True.

Примечание: ответ для Bot API следует отправить в течение 10 секунд после предварительной проверки запроса.

SuccessfulPayment — объект, который содержит информацию об успешной оплате.

См. детальное описание методов в официальной документации Telegram.

Добавление кассы для бота
Если в бизнесе нет кассы для подключения к Телеграм-боту, нажмите на кнопку «Добавить кассу» — появится форма добавления кассы.



Введите в форму:

Название кассы. Название кассы ограничено 256 символами.

Минимальную и максимальную сумму платежа в сумах.

При необходимости округления до сумов, отметьте позицию — «Округлять до сумов».

Нажмите на кнопку «Добавить» — касса добавится в бизнес.
...
Подключение бота
Отправьте BotFather команду /mybots — BotFather предложит выбрать бот. Выберите бот и нажмите на кнопку “Bot Settings” — появится меню.



В меню нажмите кнопку “Payments” — BotFather предложит выбрать платёжную систему.



В списке платёжных систем нажмите на кнопку "Paycom.Uz" — BotFather предложит выбрать тестовое или "живое" подключение.



Чтобы опробовать приём платежей в тестовом режиме без регистрации, нажмите кнопку "Connect Paycom Test".

Чтобы начать приём платежей с помощью Payme, нажмите на кнопку "Connect Paycom Live" — запустится веб-браузер.

В браузере, в форме авторизации:

введите номер мобильного телефона и пароль от кабинета Payme BUSINESS;

нажмите на кнопку «Войти» — появится список ваших бизнесов в Payme BUSINESS.



к сведению
Если вы не зарегистрированы в Payme BUSINESS: Зарегистрируйтесь и добавьте бизнес. Заключите договор с банком-партнёром Payme BUSINESS — банк-партнёр откроет для вашей компании транзитный счёт, создаст ePOS и активирует бизнес. Войдите в бизнес через Телеграм-бот и добавьте кассу для бота.

к сведению
Внимание: Невозможно добавить кассу для бота в неактивный бизнес. Телеграм-бот работает только с кассой для бота. С другими кассами Телеграм-бот не работает. Чтобы добавить кассу для бота, войдите в бинес через Телеграм-бот.

Выберите бизнес и нажмите на кнопку «Выбрать» — появится список касс для подключения к Телеграм-боту.



Выберите кассу и нажмите на кнопку «Выбрать» — касса подключится к Телеграм-боту.



к сведению
Если у вас есть активные кассы, то нужно создать отдельную кассу для Телеграм-бота.

Если вы не получили токен:
...
Над выбором меню платежных систем показаны все полученные токены.
...
Техническая поддержка
Если возникнут вопросы — звоните в техподдержку по телефонам:
